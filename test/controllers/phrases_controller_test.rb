...
class PhrasesControllerTest < ActionController::TestCase
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post :create, phrase: { claim_id: @phrase.claim_id, position: @phrase.position, theorem_id: @phrase.theorem_id }
    end
  ...
  test "should update phrase" do
    patch :update, id: @phrase, phrase: { claim_id: @phrase.claim_id, position: @phrase.position, theorem_id: @phrase.theorem_id }
    assert_redirected_to phrase_path(assigns(:phrase))
  end
