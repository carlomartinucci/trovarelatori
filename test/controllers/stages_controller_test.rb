...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { journey_id: @stage.journey_id, stageable_id: @stage.stageable_id, stageable_type: @stage.stageable_type }
    end
  ...
  test "should update stage" do
    patch :update, id: @stage, stage: { journey_id: @stage.journey_id, stageable_id: @stage.stageable_id, stageable_type: @stage.stageable_type }
    assert_redirected_to stage_path(assigns(:stage))
  end
